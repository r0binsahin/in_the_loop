...
export const Carousel = ({ questions }: CarouselProps) => {
  ...
  return (
    <motion.div
      ...
      className='h-[calc(100vh-64px)] w-full flex items-center justify-center relative bg-cover overflow-hidden'
          ...
          <AnimatePresence custom={{ direction, width }}>
            {
              <motion.div
                ...
                className='z-10 flex flex-col min-h-[230px] bg-[#0e0e0e]/65 text-[#f5e9dd]  rounded-[35px] m-5 p-6 absolute md:m-10 md:max-w-2xl md:min-h-[312px] md:p-10 shadow-[0_5px_40px_rgba(0,0,0,0.1)] backdrop-blur-[12.5px]'
              >
                {isWelcome ? (
                  <WelcomeCard />
                ) : (
